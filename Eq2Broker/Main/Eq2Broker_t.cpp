...
bool Eq2Broker_t::InitHandlers() {
  using Stage = DP::Stage_t;
...
void Eq2Broker_t::ReadConsoleLoop() {
...
bool Eq2Broker_t::ReadConsoleCommand(TCHAR buf[], DWORD dwSize) {
...
bool Eq2Broker_t::DispatchCommand(const wchar_t* buf) {
...
bool Eq2Broker_t::CmdControl(const wchar_t* pszCmd) {
