...
// TiBase_t.h
//
// TextTable_t interpreter helper class
//
/////////////////////////////////////////////////////////////////////////////
...
public:
    ...
    typedef TextTableData_t<LineCount, CharsPerLine, MaxColumnCount> Text_t;

private:

    static const bool s_EXTRALOG = false;

    Text_t  m_Text;
    mutable size_t  m_SameTextCount;
