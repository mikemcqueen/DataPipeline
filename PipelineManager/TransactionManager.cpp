...
/*static*/
  TransactionManager_t& TransactionManager_t::Get() {
  ...
  TransactionManager_t::TransactionManager_t()
  {
  }

  ///////////////////////////////////////////////////////////////////////////////

  bool TransactionManager_t::ExecuteTransaction(
  ...
  void TransactionManager_t::ExecuteNotify(
    Transaction::Data_t* pPrevTxData)
  {
  ...
  void TransactionManager_t::CompleteTransaction(
  ...
  /* static */
  void CALLBACK TransactionManager_t::ApcExecute(ULONG_PTR Param) {
  ...
  /* static */
  void CALLBACK TransactionManager_t::ApcComplete(ULONG_PTR Param) {
    TransactionManager_t& tm = GetTransactionManager();
  ...
  TransactionManager_t::Data_t* TransactionManager_t::GetTransactionExecuting() {
    CLock lock(m_cs);
    if (!m_stack.empty()) {
      return &m_stack.back();
    }
  ...
  bool TransactionManager_t::SetTransactionExecuting(
  ...
  Transaction::Data_t* TransactionManager_t::Acquire() {
    CLock lock(m_cs);
    Data_t* pData = GetTransactionExecuting();
    if (nullptr == pData)
      return nullptr;
  ...
  void TransactionManager_t::Release(
    Transaction::Data_t* pTxData,
    bool /*bQuiet*/)
  {
    CLock lock(m_cs);
  ...
  TransactionManager_t::Data_t* TransactionManager_t::FindTransaction(
  ...
  void TransactionManager_t::ExecuteNext() {
    Transaction::Data_t* pPrevTxData = nullptr;
    CLock lock(m_cs);
    if (!m_stack.empty()) {
