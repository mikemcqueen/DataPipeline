...
namespace DP {
  ...
  /* static */
  PipelineManager_t& PipelineManager_t::Get() {
  ...
  public:
    ...
    value_type GetStageName(Stage_t stage) {
  ...
  void PipelineManager_t::Free(void* pMem) {
    free(pMem);
  }
  ...
  void PipelineManager_t::QueueApc(
    PAPCFUNC  ApcFunc,
    ULONG_PTR Param)
  {
